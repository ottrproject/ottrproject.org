...
![_bookdown.yml file showing the references file as the last file](resources/images/references_bookdown.png)
...
![_output.yml file showing the split.bibset to false](resources/images/false_split_ref.png)
...
![Google Analytics account setup](resources/images/GA_account.png)
...
![Google Analytics terms](resources/images/GA_terms.png)

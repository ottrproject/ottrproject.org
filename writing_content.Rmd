...
Now we can add/edit/rename currently existing files while protecting your `main` branch. Adding changes to a branch is called making `commits`.

To commit changes, first, edit a file and code just like we normally would (you can use any text editor). Go ahead and make an edit to [some of the files listed in the above section](#file-changes-to-be-made).

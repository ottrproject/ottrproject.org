...
- [OTTR Entry Level](#ottr-entry-level) - if you do not have interest in diving into GitHub, use this version. It is done completely through the GitHub web browser.
...
In your OTTR repository, on your new branch, you can add/edit/rename currently existing files
...
Follow the steps for how to commit changes and commit the edits to your _bookdown.yml to your current branch.

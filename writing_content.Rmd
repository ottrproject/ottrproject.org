...
the files that are made live from their content are automatically created and stores in the `docs` folder. As our writing process that is described here will inform you, you should NOT make direct changes to the `docs` folder. The automation processes will overwrite the files in that folder effectively deleting your changes. Go through this section to understand how to edit your files and write your course. 
...
**Important:** ⚠️ Your Google Slide document must be set to

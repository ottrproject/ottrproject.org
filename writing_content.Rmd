...
-   You can make videos of your slides that can be added to your course
    using [Loqui](https://loqui.fredhutch.org/), an interactive web app for generating automated courses. Loqui takes an input a Google Slides URL, then extracts the speaker notes from the slides, converting them to an audio element of the video. Then, it converts the slides to images to serve as the visual component of the video.

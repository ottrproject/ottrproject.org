...
The live content is automatically created and stored in the `docs` folder. As our writing process guide will inform you, you should NOT make direct changes to the `docs` folder. The automation processes will overwrite the files in that folder effectively deleting your changes. Go through this section to understand how to edit your files and write your course. 

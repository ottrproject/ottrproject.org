...
Here is a list of examples courses made with the [main OTTR Template](https://github.com/jhudsl/OTTR_Template) and has been published in three platforms: Bookdown, Leanpub and Coursera.
...
- Go to the [OTTR_Template_Website](https://github.com/jhudsl/OTTR_Template_Website) to get started.
...
By default `make-book-txt: TRUE`, meaning the order of your chapters and quizzes will attempt to be automatically determined by numbering, but if you'd like to manually specify what order the chapters and quizzes should come in on Leanpub, then set this to `make-book-txt: FALSE`.

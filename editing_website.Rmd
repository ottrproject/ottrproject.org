...
<p class="comment">
**WARNING**: The live content is automatically created and stored in the `docs` folder. As our writing process guide will inform you, you **should NOT make direct changes to the `docs` folder**. The automation processes will handle the preparation of these files, and you should refrain from making direct changes to them. To learn how to edit your files and edit your website, please review the corresponding section in the writing process guide.
</p>
...
Additionally you can lear more about this \_site.yml file from https://rmarkdown.rstudio.com/lesson-13.html

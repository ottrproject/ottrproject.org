...
- **Customizeable branding** Follow our guides to [customize the style of your website or course](./customize-style.html) to show your own branding.
- **[Customize your own Docker image](./customize-docker.html)** for your particular needs.
- **Displaying code friendly** If you plan to include code, use [our Docker image](https://hub.docker.com/repository/docker/jhudsl/course_template) for consistency across authors as well as to help you [avoid dependency hell](https://en.wikipedia.org/wiki/Dependency_hell).  

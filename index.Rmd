...
- **Avoid dependency hell** If you plan to include code examples in your website or course use [our Docker image](https://hub.docker.com/repository/docker/jhudsl/course_template) for consistency across authors as well as to help you [avoid dependency hell](https://en.wikipedia.org/wiki/Dependency_hell).  
...
<a href="https://ottrproject.org/getting_started.html">
  <img src="resources/images/getstarted.png">
</a>

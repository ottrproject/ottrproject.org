...
#### Github action for testing your Docker image
...
In whichever repository you choose to store your Dockerfile, its recommended you use a GitHub action to automatically test it when you make changes. You can use our Docker handling [GitHub action here as a starting point](https://github.com/jhudsl/ottr_docker/blob/main/.github/workflows/docker-test.yml).

You may need to modify this for your own purposes. And you will definitely need to set up the Dockerhub credentials as described above.

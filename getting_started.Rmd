...
On the [landing page of this repository](https://github.com/jhudsl/OTTR_Template_Website), locate the green "Use this template" in the upper right corner. Click on it and then "Create a new repository" to follow the provided instructions to configure your course's GitHub repository.
